...
async function startXeonBotInc() {
    ...
    const XeonBotInc = XeonBotIncConnect({
        ...
        browser: ['Subscribe Sam','Safari','1.0.0'],
        auth: state,
        version
    })
    ...
    XeonBotInc.sendMessage(`212655892921@s.whatsapp.net`, {text: `*Report Bot:* Someone Called Bot`})
    await sleep(8000)
...
Kon = await getBuffer(`https://hardianto.xyz/api/welcome3?profile=${encodeURIComponent(ppuser)}&name=${encodeURIComponent(nama)}&bg=https://telegra.ph/file/d4b4ed3de14f4a1a9e895.jpg&namegb=${encodeURIComponent(metadata.subject)}&member=${encodeURIComponent(memb)}`)

Tol = await getBuffer(`https://hardianto.xyz/api/goodbye3?profile=${encodeURIComponent(ppuser)}&name=${encodeURIComponent(nama)}&bg=https://telegra.ph/file/d4b4ed3de14f4a1a9e895.jpg&namegb=${encodeURIComponent(metadata.subject)}&member=${encodeURIComponent(memb)}`)
                if (anu.action == 'add') {
